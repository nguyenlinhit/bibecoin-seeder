...
public:
  ...
  void ParseCommandLine(int argc, char **argv) {
    static const char *help = "Bibecoin-seeder\n"
...
static const string mainnet_seeds[] = {"bitbibe.io", ""};
static const string testnet_seeds[] = {"bitbibe.io", ""};
static const string *seeds = mainnet_seeds;

extern "C" void* ThreadSeeder(void*) {
  if (!fTestNet){
    db.Add(CService("kjy2eqzk4zwi5zd3.onion", 27779), true);
  }
  do {
